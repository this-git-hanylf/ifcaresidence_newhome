...
const Home = props => {
  ...
  useEffect(async () => {
    ...
    // );
    await axios
      .get(`http://34.87.121.155:2121/apiwebpbi/api/first_login_Get/` + email)
      .then(res => {
  ...
  const getImageGreetings = async () => {
    ...
    // );
    await axios
      .get(`http://34.87.121.155:2121/apiwebpbi/api/greetings_mobile`)
      .then(res => {
        // console.log('res greetings', res.data.data);
  ...
  const pressChairmanMessage = async () => {
    ...
    await axios
      .post(`http://34.87.121.155:2121/apiwebpbi/api/first_login/` + email)
      .then(res => {
